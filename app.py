...
if st.button("📝 Generate Notes"):
    ...
    if not notes_topic.strip():
        ...
        st.success(
            f"📚 Notes created for **{notes_topic}**!"
        )
        ...
        st.write(
            f"{notes_topic} is an important concept that helps "
            f"students understand the fundamentals of the subject."
        )
        ...
        st.info(
            f"📊 These notes are prepared for "
            f"**{notes_level}** level."
        )
